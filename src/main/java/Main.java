		...
		try {
			...
			String g2aSearchString = searchString.replaceAll(" ", "%20");
		      ...
		      for (int i = 0; i < steamDiscountPrice.size(); i++) {
		    	  System.out.println("Title: " + steamGameTitle.get(i).text() + " Current price: " + steamDiscountPrice.get(i).text());
		      }
		      
		      System.out.println("-----------------------------------------");
		      
		      System.out.println("G2A PRICES");
		      for (int i = 0; i < g2aDiscountPrice.size(); i++) {
		    	  System.out.println("Title: " + g2aGameTitle.get(i).text() + " Current price: " + g2aDiscountPrice.get(i).text());
		      }
